...
import type { ResponseGetAll, EmitirGre, ResponseEmitirGre } from '../types/gre.type'
...
export default class GreApi extends BaseRequestApi {
  ...
  public async emitirGre(body: EmitirGre, idPaquete: number): Promise<BodyResponse<ResponseEmitirGre>> {
    return this.POST<ResponseEmitirGre>(`${this.base_url_production}/${idPaquete}/guia`, body) as Promise<BodyResponse<ResponseEmitirGre>>;
  }
}
