...
import { User, Edit2, UserX, Mail, ChevronRight} from 'lucide-react';
...
export default function DetallesEmpleado({ showDetallesEmpleado, idEmpleado }: DetallesEmpleadoProps) {
  ...
  if (isLoading) {
    return (
      <div className="flex justify-center items-center py-20">
        <Loading w={12} h={12} color="blue" />
      </div>
    )
  }

  if (empleado === null) {
    return <div>Los datos del empleado no están disponibles.</div>;
  }
        ...
        <div className="flex items-start gap-6">
          ...
          <div className="flex-1">
            ...
            <div className="flex gap-3">
              ...
              <button 
                className="flex items-center gap-2 px-5 py-2.5 border border-[#30363d] hover:bg-[#161b22] rounded-lg transition-colors text-sm font-medium"
              >
