			...
			>
				<div className="space-y-6 px-6 pb-2">
					<div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
						<section className="lg:col-span-8 bg-gray-900 border border-gray-800 rounded-2xl p-4 shadow-lg">
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
								<div className="rounded-xl border border-gray-800 bg-gray-950/40 p-4">
									<p className="text-xs uppercase tracking-widest text-gray-500">Ubigeo</p>
									<p className="text-sm text-white">{establecimiento?.ubigeo ?? "No registrado"}</p>
								</div>

								<div className="rounded-xl border border-gray-800 bg-gray-950/40 p-4">
									<p className="text-xs uppercase tracking-widest text-gray-500">Fecha de registro</p>
						...
						<section className="lg:col-span-4 bg-gray-900 border border-gray-800 rounded-2xl p-4 shadow-lg space-y-4">
							<div className="flex items-center gap-3">
								...
								<div>
									...
									<h3 className="text-lg font-semibold text-white">{establecimiento?.nombreUsuario} {establecimiento?.apellidopaterno} {establecimiento?.apellidomaterno} </h3>
								</div>
							</div>

							<div className="space-y-3 pt-2">
								<div className="flex flex-row gap-2 rounded-xl border border-gray-800 bg-gray-950/40 p-4">
									<p className="text-xs uppercase tracking-widest text-gray-500">DNI:</p>
									<p className="text-sm text-white">{establecimiento?.dniuser ?? "No registrado"}</p>
								</div>
								<div className="flex flex-row gap-2 rounded-xl border border-gray-800 bg-gray-950/40 p-4">
									<p className="text-xs uppercase tracking-widest text-gray-500">Teléfono:</p>
					...
					<section className="bg-gray-900 border border-gray-800 rounded-2xl p-4 shadow-lg">
						<div className="flex items-center gap-2 mb-5">
							<ClipboardList className="w-5 h-5 text-blue-400" />
							<h3 className="text-lg font-semibold text-white uppercase">Información técnica</h3>
						</div>

						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							<div className="flex flex-row gap-2 rounded-xl border border-gray-800 bg-gray-950/40 p-4">
								<p className="text-xs uppercase tracking-widest text-gray-500">Latitud:</p>
								<p className="text-sm text-white">{establecimiento?.latitud || "No registrada"}</p>
							</div>
							<div className="flex flex-row gap-2 rounded-xl border border-gray-800 bg-gray-950/40 p-4">
								<p className="text-xs uppercase tracking-widest text-gray-500">Longitud:</p>
								<p className="text-sm text-white">{establecimiento?.longitud || "No registrada"}</p>
							</div>
						</div>

						<div className="flex flex-row gap-2 mt-4 rounded-xl border border-gray-800 bg-gray-950/40 p-4">
