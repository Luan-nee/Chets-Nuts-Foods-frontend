...
export default function NavBarAdministrador() {
  ...
  return (
    <div className="
      w-52 bg-gray-900 border-r border-gray-800 flex flex-col
      max-md:w-full
    ">
      <div className="p-4 border-b border-gray-800 flex items-center justify-between">
        ...
        <button
          type="button"
          className="bg-blue-600 rounded-md px-3 py-2 md:hidden text-white transition-colors"
          onClick={() => setShowNavBar(!showNavBar)}
        >
          {showNavBar ? "Cerrar" : "Abrir"}
        </button>
      </div>

      <div className={`${showNavBar ? "flex" : "hidden"} flex-col md:flex`}>
